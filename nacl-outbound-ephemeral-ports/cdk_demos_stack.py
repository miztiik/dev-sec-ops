...
class CdkDemosStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        core.Tag.add(vpc,key="Name",value="KonStone")
        ...
        web_sg.add_ingress_rule(ec2.Peer.any_ipv4(), ec2.Port.tcp(80), "allow web access from the world")
        ...
        working_nacl.add_entry("working_nacl_in_rule_110",
        ...
        working_nacl.add_entry("working_nacl_out_rule_110",
                                cidr=ec2.AclCidr.any_ipv4(),
                                rule_number=120,
        ...
        ec2Instance = ec2.CfnInstance(self,
                                    "web-instance",
                                    image_id=ami_id,
